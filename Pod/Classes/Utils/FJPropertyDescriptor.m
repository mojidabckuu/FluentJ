...
//    FJPropertyDescriptor *attributes = calloc(1, sizeof(FJPropertyDescriptor) + typeLength + 1);
//    if (!attributes) {
...
//            attributes->typeClass = objc_getClass(trimmedName);
//        }
//    }
//    
//    if (*next != '\0') {
...
//                
//            case 'C':
//                attributes->memoryManagementPolicy = FJPropertyMemoryManagementPolicyCopy;
//                break;
//                
//            case '&':
//                attributes->memoryManagementPolicy = FJPropertyMemoryManagementPolicyRetain;
//                break;
//                
//            case 'N':
