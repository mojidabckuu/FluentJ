...
+ (instancetype)transformerUsingForwardBlock:(FJValueTransformBlock)forwardBlock userInfo:(NSDictionary *)userInfo {
    return [[self alloc] initWithForwardBlock:forwardBlock reverseBlock:nil userInfo:userInfo];
}

+ (instancetype)transformerUsingReversibleBlock:(FJValueTransformBlock)reversibleBlock userInfo:(NSDictionary *)userInfo {
    return [self transformerUsingForwardBlock:nil reverseBlock:reversibleBlock userInfo:userInfo];
}
...
- (id)initWithForwardBlock:(FJValueTransformBlock)forwardBlock reverseBlock:(FJValueTransformBlock)reverseBlock userInfo:(NSDictionary *)userInfo {
